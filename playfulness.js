...
(function(){
  ...
  const FOLLOWUPS={
    ...
    pref:['这个偏好是一直这样，还是恋爱以后变了？','TA 以后记住这一点，最适合怎么做？','这项偏好你有多坚持？'],
    sweet:['为什么这件事能打到这个分数？','如果由 TA 亲自做，分数会不会再加一格？','这里面最戳你的具体瞬间是什么？'],
    odd:['不许改答案，给自己的选择找一个正经理由。','如果真发生了，谁会先后悔？','让 TA 替你辩护一下这个离谱答案。'],
    talk:['这句话里有没有一部分你平时不太会主动说？','如果 TA 追问一句“为什么”，你会怎么答？','听完 TA 的答案，你最想接哪一句？']
  };
